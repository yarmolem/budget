...
import { RecentSales } from "@/components/shared/dashboard-recent-expenses";
import {
  Area,
  AreaChart,
  CartesianGrid,
...
import { ReChartsTooltip } from "@/components/shared/recharts-tooltip";
      ...
      <div className="mb-4 grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <Card className="col-span-3">
          <CardHeader>
            ...
            <CardDescription>You made 265 incomes this month.</CardDescription>
          </CardHeader>
          <CardContent>
            <RecentSales />
          </CardContent>
